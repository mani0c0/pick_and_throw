...
from .pose_command_h import UniformPoseCommand
from .velocity_command_h import UniformVelocityCommand_H


@configclass
class UniformPoseCommandCfg_H(CommandTermCfg):
...
@configclass
class UniformVelocityCommandCfg_H(CommandTermCfg):
    """Configuration for the uniform velocity command generator."""

    class_type: type = UniformVelocityCommand_H
